...
class Ui_DaisyMain(object):
    def setupUi(self, DaisyMain):
        ...
        self.pushButtonClose1 = QtGui.QPushButton(self.tab_1)
        ...
        self.lineEditFileCounter = QtGui.QLineEdit(self.tab_1)
        ...
        self.toolButtonCopyDest = QtGui.QToolButton(self.tab_1)
        ...
        self.checkBoxCopyBhzIntro = QtGui.QCheckBox(self.tab_1)
        ...
        self.toolButtonCopySource = QtGui.QToolButton(self.tab_1)
        ...
        self.toolButtonCopyFile1 = QtGui.QToolButton(self.tab_1)
        ...
        self.checkBoxCopyBitrateChange = QtGui.QCheckBox(self.tab_1)
        ...
        self.lineEditCopyDest = QtGui.QLineEdit(self.tab_1)
        ...
        self.checkBoxCopyID3Change = QtGui.QCheckBox(self.tab_1)
        ...
        self.comboBoxCopyBhzAusg = QtGui.QComboBox(self.tab_1)
        ...
        self.label.setGeometry(QtCore.QRect(30, 410, 101, 21))
        self.label.setObjectName(_fromUtf8("label"))
        self.label_14 = QtGui.QLabel(self.tab_1)
        self.label_14.setGeometry(QtCore.QRect(230, 410, 91, 21))
        self.label_14.setObjectName(_fromUtf8("label_14"))
        self.label_7 = QtGui.QLabel(self.tab_1)
        self.label_7.setGeometry(QtCore.QRect(20, 470, 610, 17))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.comboBoxDaisyTrenner = QtGui.QComboBox(self.tab_1)
        self.comboBoxDaisyTrenner.setGeometry(QtCore.QRect(24, 490, 610, 27))
        self.comboBoxDaisyTrenner.setObjectName(_fromUtf8("comboBoxDaisyTrenner"))
        self.label_13 = QtGui.QLabel(self.tab_1)
        self.label_13.setGeometry(QtCore.QRect(20, 530, 610, 17))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.comboBoxPrefBitrate = QtGui.QComboBox(self.tab_1)
        self.comboBoxPrefBitrate.setGeometry(QtCore.QRect(24, 550, 610, 27))
        ...
        self.textEdit.setGeometry(QtCore.QRect(24, 90, 610, 541))
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.progressBarCopy = QtGui.QProgressBar(self.tab_2)
        self.progressBarCopy.setGeometry(QtCore.QRect(24, 640, 610, 25))
        ...
        self.line_5.setGeometry(QtCore.QRect(0, 60, 790, 3))
        ...
        self.toolButtonDaisySource = QtGui.QToolButton(self.tab_4)
        ...
        self.lineEditDaisySource = QtGui.QLineEdit(self.tab_4)
        ...
        self.progressBarDaisy = QtGui.QProgressBar(self.tab_4)
    ...
    def retranslateUi(self, DaisyMain):
        ...
        self.lineEditFileCounter.setText(_translate("DaisyMain", "Counter-Datei waehlen", None))
        ...
        self.label_1.setText(_translate("DaisyMain", "Daisy-Tool-Special", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("DaisyMain", "3 Meta", None))
